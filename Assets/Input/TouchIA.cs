...
//     version 1.13.1
//     from Assets/Input/TouchIA.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Input/TouchIA.inputactions".
/// </summary>
/// <remarks>
...
/// </code>
/// </example>
public partial class @TouchIA: IInputActionCollection2, IDisposable
{
    /// <summary>
    ...
    ~@TouchIA()
    {
        UnityEngine.Debug.Assert(!m_Touch.enabled, "This will cause a leak and performance issues, TouchIA.Touch.Disable() has not been called.");
    }
